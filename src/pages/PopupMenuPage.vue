      ...
      <div class="content">
        <section>
          ...
          <div class="demoWrap" @contextmenu.stop.prevent="$refs.popupmenu_areas.showPopupMenu($event, datas);">
            ...
            <span class="f_r p_b_1" @mouseup="$event.stopPropagation()" @mouseenter="$refs.popupmenu_right.showPopupMenu($event, deepCopy(datasCopy_right));" @mouseleave="leaveHidePopupMenu" @contextmenu.stop.prevent="">
